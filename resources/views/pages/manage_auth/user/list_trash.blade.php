  ...
  $(() => {
    ...
    table = $(".dt-wow").DataTable({
      ...
      columns: [
        ...
        { searchable: true, orderable: true, name: 'kode', data: 'kode',
          render: (data, type, row) => {
            if(allow.show){
        ...
        { searchable: true, orderable: true, name: 'cabang', data: 'cabang',
          render: (data, type, row) => {
            return data
          }
        },
        { searchable: true, orderable: true, name: 'kota', data: 'kota',
          render: (data, type, row) => {
            return data
          }
        },
        { searchable: true, orderable: true, name: 'kota', data: 'kota',
          render: (data, type, row) => {
            if(row?.induk?.kode){
              return row?.induk?.kode+' '+row?.induk?.cabang
            }
            return ''
          }
        },
