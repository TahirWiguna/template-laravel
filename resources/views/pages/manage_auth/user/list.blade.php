      ...
      table = $(".dt-wow").DataTable({
        ...
        columns: [{
            ...
            render: (data, type, row) => {
              ...
              ${allow.delete ? `<button onclick="destroy(${data})" type="button" class="btn btn-sm btn-default" title="Hapus"><i class="fas fa-trash"></i></button>`: '' }
