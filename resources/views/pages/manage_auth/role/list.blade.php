...
<script>
  ...
  let _url = {
    ...
    permission: `{{ route($module.'.permission', ':id') }}`,
  }
        ...
        { searchable: false, orderable: false, name: 'id', data: 'id', className: 'text-center',
          render: (data, type, row) => {
            html = `<div class="btn-group btn-group-sm" branch="group">
              ...
              ${allow.permission ? `<a href="${_url.permission.replace(':id', data)}" type="button" class="btn btn-sm btn-default" title="Permission"><i class="fas fa-cog"></i></a>`: '' }
            </div>`
